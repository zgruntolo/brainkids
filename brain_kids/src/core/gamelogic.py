...
class GameLogic:
    def __init__(
        ...
        self.default_chart_filename = default_chart_filename
    ...
    def load_game_data(self):
        ...
        scoreboard.load(self.default_chart_path, self.default_chart_filename)
    ...
    def verify_player_answer(self, player_answer):
        # Check if the player's answer is correct and update the score accordingly
    ...
    def save_player_score(self):
        ...
        scoreboard.save(self.default_chart_filename)
