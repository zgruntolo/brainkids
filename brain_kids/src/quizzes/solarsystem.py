...
DIFFICULTY_RANK = {"Facile": 1}
DATA_FILE = ABSOLUTE_PATH / "data" / "solarsystem" / "files" / "images.json"
IMAGE_DIR = ABSOLUTE_PATH / "data" / "solarsystem" / "images"
DEFAULT_CHART = ABSOLUTE_PATH / "data" / "solarsystem" / "files" / "chart.json"
CHART_FILENAME = "solarsystem.json"


def SolarSystem(renderer):
