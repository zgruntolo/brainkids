...
DATA_FILE = ABSOLUTE_PATH / "data" / "animals" / "files" / "images.json"
IMAGE_DIR = ABSOLUTE_PATH / "data" / "animals" / "images"
DEFAULT_CHART = ABSOLUTE_PATH / "data" / "animals" / "files" / "chart.json"
CHART_FILENAME = "animals.json"


def Animals(renderer):
