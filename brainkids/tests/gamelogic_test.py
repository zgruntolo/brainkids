...
class TestGameLogic(unittest.TestCase):
    ...
    def test_assign_player_name(self):
        ...
        self.assertEqual(self.game_logic.game_state.avatar_name, "Tommaso")
    ...
    def test_display_next_image(self):
        self.game_logic.game_state.category = {"Vivente": 0, "Non Vivente": 0}
        ...
        self.game_logic.game_state.category = {"Vivente": 1, "Non Vivente": 1}
        self.mock_ui_callback.reset_mock()

    def test_verify_player_answer(self):
        self.game_logic.current_image_category = "Vivente"
        self.game_logic.game_state.avatar_score = 0
        self.game_logic.game_state.category = {"Vivente": 1, "Non Vivente": 0}
        self.game_logic.preloaded_images = {
            "Vivente": ["pappagallo.png"],
            "Non Vivente": ["sasso.png"],
        }
        ...
        self.assertEqual(self.game_logic.game_state.avatar_score, 10)
    ...
    def test_check_answer_wrong(self):
        ...
        self.assertEqual(self.game_logic.game_state.avatar_score, 0)

    def test_save_score(self):
        with patch("src.core.gamelogic.chart") as mock_chart:
            self.game_logic.game_state.avatar_name = "Tommaso"
            self.game_logic.game_state.avatar_score = 50
    ...
    def test_end_game(self):
        with patch("src.core.gamelogic.chart") as mock_chart:
            ...
            self.mock_ui_callback.assert_called_with(
                "display_game_results", self.game_logic.game_state.chart
            )
