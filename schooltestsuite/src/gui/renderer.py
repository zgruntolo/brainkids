...
class Renderer:
    ...
    def show_game_selection_screen(self, game_option):
        ...
        self.update_screen("src/gui/images/intro.png", "Scegli un gioco:")
    ...
    def request_player_name(self):
        ...
        self.update_screen(
            "src/gui/images/name.png", "Benvenuto! Inserisci il tuo nome:"
        )
    ...
    def request_game_difficulty(self, difficulty_levels):
        ...
        self.update_screen("src/gui/images/difficulty.png", "Scegli la difficoltà:")
        self.create_buttons(
